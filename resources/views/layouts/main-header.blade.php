				...
				<div class="container-fluid">
					...
					<div class="main-header-right">
						<div class="nav nav-item  navbar-nav-right ml-auto">
							<h6 class="align-middle">{{ Auth::user()->name }}</h6>
						</div>
									...
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											<div class="mr-3 my-auto">
												<h6>{{ Auth::user()->name }}</h6><span>{{ Auth::user()->position }}</span>
											</div>
										</div>
									</div>
									<a class="dropdown-item" href=""><i class="bx bx-user-circle"></i>Profile</a>
									<a class="dropdown-item" href=""><i class="bx bx-cog"></i> Edit Profile</a>
									<a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit()"><i class="bx bx-log-out"></i> Log Out</a>
